    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle className="font-display tracking-wider">Nova Vaga por Sede</DialogTitle>
              <DialogDescription>Defina a cidade e o número de vagas</DialogDescription>
            </DialogHeader>
